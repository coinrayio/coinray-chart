...
/**
 * Consumer-facing interface for the replay engine.
 * Exposes only the playback API — internal host-wiring methods are omitted.
 */
export interface ReplayEngine {
  setCurrentTime: (timestamp: Nullable<number>, endTime?: Nullable<number>) => Promise<void>
